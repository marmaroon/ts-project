...
// never - никогда не заканчивается возвращаемым значением, подходит для выброса ошибок и для запуска синхронного кода, который никогда не завершится (например while (true), либо рекурсий (в теории)
